...
import { Menu, X, Home, ChefHat, History, LogOut } from "lucide-react"
...
export function KitchenSidebar() {
  ...
  const menuItems = [
    { href: "/kitchen/dashboard", label: "Dashboard", icon: Home },
    { href: "/kitchen/orders", label: "Orders", icon: ChefHat },
