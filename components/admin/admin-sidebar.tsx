...
import { Menu, X, LayoutDashboard, UtensilsCrossed, ClipboardList, Users, SettingsIcon, LogOut } from "lucide-react"
      ...
      >
        <div className="flex flex-col h-full pt-20 lg:pt-8">
          ...
          <div className="px-6 pb-8 border-b border-[#7A1E1E]">
            ...
            <p className="text-xs text-[#FFD700]/70 mt-1">Admin Panel</p>
          </div>
