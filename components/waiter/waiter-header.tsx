...
// Local helper similar to WaiterSidebar
...
export function WaiterHeader() {
  ...
  // Fetch restaurant info (name + address)
  useEffect(() => {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-[#E2E8F0] flex items-center justify-between px-4 sm:px-6 h-16 lg:ml-64">
        {/* Left: title (shifted on mobile so menu icon doesn’t cover it) */}
        <div className="flex items-center gap-2 min-w-0 ml-12 sm:ml-0">
